...
function AboutPage() {
  ...
  return (
    <SiteShell>
      <section className="px-6 py-10 md:px-14 md:py-14 lg:px-24">
        <div className="mx-auto w-full max-w-3xl">
          ...
          <p className="mt-5 max-w-xl text-base leading-8 text-muted-foreground">{content.about.intro}</p>
        </div>
      </section>
      ...
      <section className="bg-secondary px-6 py-16 md:px-14 md:py-24 lg:px-24">
        <div className="mx-auto w-full max-w-3xl">
